<%@ Page Title="Character_TableDelete" Language="C#" MasterPageFile="~/Frontend.Master" CodeBehind="Delete.aspx.cs" Inherits="COMP2007_FInalAssignment.Character_Table1.Delete" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <h3>Are you sure want to delete this Character_Table?</h3>
        <asp:FormView runat="server"
            ...
            <ItemTemplate>
                <fieldset class="form-horizontal">
                    <legend>Delete Character_Table</legend>
							<div class="row">
