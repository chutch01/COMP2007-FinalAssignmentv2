...
namespace COMP2007_FInalAssignment.SkillChart_Faith_Table1
{
    public partial class Delete : System.Web.UI.Page
    {
        ...
        // This is the Delete methd to delete the selected SkillChart_Faith_Table item
        ...
        public void DeleteItem(int SkillId)
        {
            using (_db)
            {
                ...
                if (item != null)
                {
                    _db.SkillChart_Faith_Table.Remove(item);
                    _db.SaveChanges();
                }
            }
        ...
        // This is the Select methd to selects a single SkillChart_Faith_Table item with the id
        ...
        public COMP2007_FInalAssignment.SkillChart_Faith_Table GetItem([FriendlyUrlSegmentsAttribute(0)]int? SkillId)
        {
            ...
            using (_db)
            {
	            return _db.SkillChart_Faith_Table.Where(m => m.SkillId == SkillId).FirstOrDefault();
            }
        }
