<%@ Page Title="SkillChart_General_TableList" Language="C#" MasterPageFile="~/Frontend.Master" CodeBehind="Default.aspx.cs" Inherits="COMP2007_FInalAssignment.SkillChart_General_Table1.Default" %>
<%@ Register TagPrefix="FriendlyUrls" Namespace="Microsoft.AspNet.FriendlyUrls" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <h2>SkillChart_General_Table List</h2>
    <p>
    ...
    <div>
        <asp:ListView id="ListView1" runat="server"
			...
			ItemType="COMP2007_FInalAssignment.SkillChart_General_Table"
            SelectMethod="GetData">
            <EmptyDataTemplate>
                There are no entries found for SkillChart_General_Table
            </EmptyDataTemplate>
            <LayoutTemplate>
                <table class="table">
                    <thead>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/SkillChart_General_Table/Details", Item.SkillId) %>' Text="Details" /> | 
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/SkillChart_General_Table/Edit", Item.SkillId) %>' Text="Edit" /> | 
                        <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/SkillChart_General_Table/Delete", Item.SkillId) %>' Text="Delete" />
                    </td>
                </tr>
            </ItemTemplate>
        </asp:ListView>
