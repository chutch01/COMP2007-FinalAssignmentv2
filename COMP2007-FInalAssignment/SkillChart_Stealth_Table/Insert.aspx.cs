...
namespace COMP2007_FInalAssignment.SkillChart_Stealth_Table1
{
    public partial class Insert : System.Web.UI.Page
    {
        ...
        // This is the Insert method to insert the entered SkillChart_Stealth_Table item
        // USAGE: <asp:FormView InsertMethod="InsertItem">
        public void InsertItem()
        {
            using (_db)
            {
                var item = new COMP2007_FInalAssignment.SkillChart_Stealth_Table();
                ...
                {
                    // Save changes
                    _db.SkillChart_Stealth_Table.Add(item);
                    _db.SaveChanges();
