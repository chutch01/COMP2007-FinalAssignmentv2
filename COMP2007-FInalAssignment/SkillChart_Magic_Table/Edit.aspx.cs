...
namespace COMP2007_FInalAssignment.SkillChart_Magic_Table1
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        // This is the Update methd to update the selected SkillChart_Magic_Table item
        // USAGE: <asp:FormView UpdateMethod="UpdateItem">
        public void UpdateItem(int  SkillId)
        {
            using (_db)
            {
                var item = _db.SkillChart_Magic_Table.Find(SkillId);
        ...
        // This is the Select method to selects a single SkillChart_Magic_Table item with the id
        ...
        public COMP2007_FInalAssignment.SkillChart_Magic_Table GetItem([FriendlyUrlSegmentsAttribute(0)]int? SkillId)
        {
            ...
            using (_db)
            {
                return _db.SkillChart_Magic_Table.Find(SkillId);
            }
        }
