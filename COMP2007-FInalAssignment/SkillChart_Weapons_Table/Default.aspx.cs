...
namespace COMP2007_FInalAssignment.SkillChart_Weapons_Table1
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        // Model binding method to get List of SkillChart_Weapons_Table entries
        // USAGE: <asp:ListView SelectMethod="GetData">
        public IQueryable<COMP2007_FInalAssignment.SkillChart_Weapons_Table> GetData()
        {
            return _db.SkillChart_Weapons_Table;
        }
    }
}
