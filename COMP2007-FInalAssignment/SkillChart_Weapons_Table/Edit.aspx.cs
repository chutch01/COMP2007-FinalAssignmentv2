...
namespace COMP2007_FInalAssignment.SkillChart_Weapons_Table1
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        // This is the Update methd to update the selected SkillChart_Weapons_Table item
        ...
        // This is the Select method to selects a single SkillChart_Weapons_Table item with the id
        ...
        public COMP2007_FInalAssignment.SkillChart_Weapons_Table GetItem([FriendlyUrlSegmentsAttribute(0)]int? SkillId)
        {
            ...
            using (_db)
            {
                return _db.SkillChart_Weapons_Table.Find(SkillId);
            }
        }
