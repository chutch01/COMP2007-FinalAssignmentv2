<%@ Page Title="SkillChart_Weapons_TableList" Language="C#" MasterPageFile="~/Frontend.Master" CodeBehind="Default.aspx.cs" Inherits="COMP2007_FInalAssignment.SkillChart_Weapons_Table1.Default" %>
<%@ Register TagPrefix="FriendlyUrls" Namespace="Microsoft.AspNet.FriendlyUrls" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <h2>SkillChart_Weapons_Table List</h2>
    <p>
    ...
    <div>
        <asp:ListView id="ListView1" runat="server"
			...
			ItemType="COMP2007_FInalAssignment.SkillChart_Weapons_Table"
            SelectMethod="GetData">
            <EmptyDataTemplate>
                There are no entries found for SkillChart_Weapons_Table
            </EmptyDataTemplate>
            <LayoutTemplate>
                <table class="table">
                    <thead>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/SkillChart_Weapons_Table/Details", Item.SkillId) %>' Text="Details" /> | 
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/SkillChart_Weapons_Table/Edit", Item.SkillId) %>' Text="Edit" /> | 
                        <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/SkillChart_Weapons_Table/Delete", Item.SkillId) %>' Text="Delete" />
                    </td>
                </tr>
            </ItemTemplate>
        </asp:ListView>
