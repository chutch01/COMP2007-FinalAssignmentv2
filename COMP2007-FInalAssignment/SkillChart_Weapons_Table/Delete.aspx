<%@ Page Title="SkillChart_Weapons_TableDelete" Language="C#" MasterPageFile="~/Frontend.Master" CodeBehind="Delete.aspx.cs" Inherits="COMP2007_FInalAssignment.SkillChart_Weapons_Table1.Delete" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <h3>Are you sure want to delete this SkillChart_Weapons_Table?</h3>
        <asp:FormView runat="server"
            ItemType="COMP2007_FInalAssignment.SkillChart_Weapons_Table" DataKeyNames="SkillId"
            ...
            <ItemTemplate>
                <fieldset class="form-horizontal">
                    <legend>Delete SkillChart_Weapons_Table</legend>
							<div class="row">
